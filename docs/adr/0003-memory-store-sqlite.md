...
- Migration 2 adds the policies table under ADR-0004 and awaits its own packaged verification, which the integrator runs. It changes the expected packaged probe evidence to migration 2.
