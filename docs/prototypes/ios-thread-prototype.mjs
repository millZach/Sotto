// Throwaway fixture server. Only these static assets are served, on loopback.
...
const routes = new Map([
  ['/', [new URL('./ios-thread-prototype.html', import.meta.url), 'text/html; charset=utf-8']],
...
}).listen(4326, '127.0.0.1', () => stdout.write('iOS thread prototype: http://127.0.0.1:4326/\n'))
