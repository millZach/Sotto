// Local fixture-only preview. No application data, provider bridge or external requests.
...
const routes = new Map([
  ['/', [new URL('./agents-view-prototype.html', import.meta.url), 'text/html; charset=utf-8']],
...
}).listen(4324, '127.0.0.1', () => stdout.write('Agents mock-up: http://127.0.0.1:4324/\n'))
