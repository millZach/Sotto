...
Sotto used to be called TalkType. It installs alongside TalkType rather than replacing it, and the first time Sotto starts it moves your TalkType settings and history over. Uninstall TalkType afterward from Windows Settings → Apps.
...
The README's [Privacy and cost](../README.md#privacy-and-cost) table names every host Sotto connects to. This section says exactly what each one receives.
