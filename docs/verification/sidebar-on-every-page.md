...
| A thread that finishes while the window is on another page wears the finished ring, and the ring clears when Threads opens | `dictate-finished-1280x800-dark.png`, `threads-after-finished-1280x800-dark.png` | Footer links wears the green filled ring on Dictate; on Threads the row is plain again. |
