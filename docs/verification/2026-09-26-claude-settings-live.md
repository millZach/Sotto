...
Evidence for issue #317 and the September 26 amendment to `docs/adr/0023-working-reads-the-providers-agent-tasks.md`. Windows 11, 2026-09-25 and 26. **Claude Code 2.1.283**, the installed and signed-in client (`claude --version`), with the Agent SDK types pinned at 0.3.270.
