...
- `tests/unit/renderer/threadSidebarStatus.test.tsx` covers a request with no queue item, for both kinds, in the expanded row and the collapsed rail.
