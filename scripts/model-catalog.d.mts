...
export const MODEL_CATALOG: Readonly<Record<'fast' | 'balanced' | 'accurate' | 'instant', Readonly<ScriptModelCatalogEntry>>>
...
export interface CatalogLock { version: 1; presets: Record<'fast' | 'balanced' | 'accurate' | 'instant', LockedModel> }
