...
await viteBuild({ configFile: false, root, base: './', build: { outDir: resolve(output, 'renderer'), emptyOutDir: true, rollupOptions: { input: resolve(root, 'scripts/voice-perf/capture.html') } } })
