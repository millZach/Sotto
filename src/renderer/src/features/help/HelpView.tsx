  ...
  return (
    <div className="management-view help-view">
      ...
      <div className="help-grid">
        ...
        <Card><Mic aria-hidden="true" /><h2>Microphone access</h2><p>If recording cannot start, open Windows Settings, then Privacy or Privacy &amp; security, then Microphone, and allow desktop apps. Choose an available input in Sotto Settings.</p></Card>
        ...
        <Card><Download aria-hidden="true" /><h2>Optional models</h2><p>Balanced is included and works offline. Installing Instant, Fast, or Accurate contacts Hugging Face, which receives ordinary network metadata such as your IP address and request time. Audio and transcripts are not sent. Instant is English-only.</p></Card>
        <Card><ClipboardCheck aria-hidden="true" /><h2>Paste fallback</h2><p>Sotto is clipboard first: successful text is always copied. Automatic paste may be blocked in elevated, protected, or password fields and applications with custom input handling. When that happens, paste manually with Ctrl+V.</p></Card>
