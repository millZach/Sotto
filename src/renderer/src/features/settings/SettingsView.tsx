            ...
            <div className="settings-form">
              ...
              <Card className="settings-section" id="settings-privacy" {...panelProps('settings-privacy')}>
                ...
                <div className="settings-rows">
                  ...
                  <Toggle label="Show browser previews" checked={settings.showBrowserPreviews} onCheckedChange={checked => void save({ showBrowserPreviews: checked })} description="Show a small preview of the focused thread's browser task in the corner. When off, browser work still runs and Tools > Browser still shows it." />
