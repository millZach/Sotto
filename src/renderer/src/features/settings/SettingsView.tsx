            ...
            <div className="settings-form">
              ...
              <Card className="settings-section" id="settings-privacy" {...panelProps('settings-privacy')}>
                ...
                <div className="settings-rows">
                  ...
                  <Toggle label="Show the browser when an agent opens a page" checked={settings.showBrowserPreviews} onCheckedChange={checked => void save({ showBrowserPreviews: checked })} description="Open the floating browser player on its own for the focused thread. When off, the player stays closed and Tools > Browser still shows the work." />
