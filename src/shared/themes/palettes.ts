 ...
 *
 * The role list and the T3 Chat, Grove, Ocean, Ember and Iris palettes are
 * copied from T3 Code (https://github.com/pingdotgg/t3code) at commit
 * d1d15c67f4a5fb82fd8d5e01e5e3b288296789c3, packages/shared/src/themePalettes.ts.
 * Those colour values and ids are unchanged; Sotto shows them as Rose, Fern,
 * Tide, Copper and Dusk. MIT License, Copyright (c) 2026 T3 Tools Inc.; the
 * full notice is in THIRD_PARTY_NOTICES.md. The Sotto palette below is Sotto's
 * own, from the approved Threads prototype, and replaced T3's stock look on the
 * id `t3-code`.
 */
...
/**
 * Sotto's own look, the palette a new install wears: a warm paper light half,
 * a violet-inked dark half, and one strong sky accent in both. The values come
 * from the approved Threads prototype (docs/prototypes/threads-page-prototype-3.html,
 * the `sotto` look); the remaining roles are derived from the same hues so the
 * theme stays coherent, and every role is already written in canonical OKLCH.
 *
 * It keeps the id `t3-code` it shipped under, so a selection saved before this
 * repaint still resolves (ADR-0011). The palette itself is Sotto's now, not
 * T3 Code's stock look.
 */
export const SOTTO_LIGHT_THEME_COLORS: ThemeColors = {
  ...
  focus: 'oklch(0.52 0.13 235)',
  accent: 'oklch(0.52 0.13 235)',
  ...
  update: 'oklch(0.52 0.13 235)',
  updateForeground: 'oklch(0.42 0.1 235)',
  updateSurface: 'oklch(0.9 0.03 230)',
  accentSurface: 'oklch(0.9 0.03 230)',
  accentSurfaceForeground: 'oklch(0.235 0.014 75)',
  messageSurface: 'oklch(0.93 0.012 85)',
  messageForeground: 'oklch(0.235 0.014 75)',
  messageAction: 'oklch(0.52 0.13 235)',
  messageActionForeground: 'oklch(0.99 0.003 85)',
  messageActionHover: 'oklch(0.46 0.12 235)',
  ...
  sidebarRowActive: 'oklch(0.905 0.022 240)',
  sidebarRowSelected: 'oklch(0.885 0.03 235)',
  sidebarBorder: 'oklch(0.87 0.012 82)',
  terminalBackground: 'oklch(0.978 0.004 85)',
  terminalForeground: 'oklch(0.235 0.014 75)',
  terminalCursor: 'oklch(0.52 0.13 235)',
  terminalSelection: 'oklch(0.9 0.03 230)',
...
export const SOTTO_DARK_THEME_COLORS: ThemeColors = {
  canvas: 'oklch(0.235 0.018 280)',
  chrome: 'oklch(0.235 0.018 280)',
  toolbar: 'oklch(0.235 0.018 280)',
  toolbarForeground: 'oklch(0.985 0.005 280)',
  toolbarBorder: 'oklch(0.42 0.03 270)',
  toolbarControl: 'oklch(0.265 0.02 280)',
  toolbarControlForeground: 'oklch(0.985 0.005 280)',
  toolbarControlHover: 'oklch(0.305 0.022 280)',
  surface: 'oklch(0.26 0.019 280)',
  surfaceRaised: 'oklch(0.305 0.021 280)',
  surfaceOverlay: 'oklch(0.33 0.022 280)',
  text: 'oklch(0.985 0.005 280)',
  textMuted: 'oklch(0.72 0.014 265)',
  border: 'oklch(0.42 0.03 270)',
  input: 'oklch(0.48 0.032 272)',
  focus: 'oklch(0.79 0.13 220)',
  accent: 'oklch(0.79 0.13 220)',
  accentForeground: 'oklch(0.2 0.02 280)',
  secondary: 'oklch(0.265 0.02 280)',
  secondaryForeground: 'oklch(0.985 0.005 280)',
  muted: 'oklch(0.265 0.02 280)',
  ...
  update: 'oklch(0.79 0.13 220)',
  updateForeground: 'oklch(0.86 0.09 215)',
  updateSurface: 'oklch(0.335 0.05 230)',
  accentSurface: 'oklch(0.4 0.06 230)',
  accentSurfaceForeground: 'oklch(0.985 0.005 280)',
  messageSurface: 'oklch(0.3 0.024 280)',
  messageForeground: 'oklch(0.985 0.005 280)',
  messageAction: 'oklch(0.79 0.13 220)',
  messageActionForeground: 'oklch(0.2 0.02 280)',
  messageActionHover: 'oklch(0.84 0.11 218)',
  codeBackground: 'oklch(0.265 0.02 280)',
  codeForeground: 'oklch(0.985 0.005 280)',
  sidebar: 'oklch(0.205 0.016 282)',
  sidebarForeground: 'oklch(0.985 0.005 280)',
  sidebarMutedForeground: 'oklch(0.72 0.014 265)',
  sidebarControlSurface: 'oklch(0.285 0.02 280)',
  sidebarRowHover: 'oklch(0.265 0.02 280)',
  sidebarRowActive: 'oklch(0.31 0.03 270)',
  sidebarRowSelected: 'oklch(0.35 0.04 262)',
  sidebarBorder: 'oklch(0.45 0.028 275)',
  terminalBackground: 'oklch(0.235 0.018 280)',
  terminalForeground: 'oklch(0.985 0.005 280)',
  terminalCursor: 'oklch(0.79 0.13 220)',
  terminalSelection: 'oklch(0.4 0.06 230)',
  terminalScrollbar: 'oklch(0.42 0.022 280)',
  terminalScrollbarHover: 'oklch(0.52 0.02 280)',
}
