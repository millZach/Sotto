...
/**
 * The palette T3 Code wears with no theme installed, captured by T3 from its
 * stock tokens with alpha flattened over the real backdrops. Sotto ships it as
 * the default "T3 Code" theme; the hex values are decoded to OKLCH on load.
 */
